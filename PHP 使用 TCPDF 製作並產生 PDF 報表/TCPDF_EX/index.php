<?php
	...
	ob_end_clean();//克服 『TCPDF ERROR: Some data has already been output, can't send PDF file』by jash.liao
	$pdf->Output(__DIR__ .'mis-employees.pdf', 'I');//增加『__DIR__ .』克服 未指定目錄 by jash.liao
?>